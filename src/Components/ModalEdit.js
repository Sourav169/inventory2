...
export default function SimpleModal2(props) {
  ...
  const onSubmit = async(e) =>{
    ...
    await axios.put(`http://localhost:8080/customers/updateCustomer/${id}`,newObj)
    .then((res)=>{
       console.log(res);
  ...
  return (
    <div>
      <button className="form-control btn" type="submit" style={{width:"80px",backgroundColor:"green",height:'40px'}} onClick={handleOpen}>
                                Edit
                        </button>
      <Modal
        open={open}
